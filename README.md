...
CSV не хранится в Git. Для воспроизведения анализа скачайте index_1.csv и поместите его в data/index_1.csv.
...
4. Скачайте датасет с Kaggle и сохраните его как data/index_1.csv.
5. Откройте notebooks/coffee_sales_eda.ipynb в Jupyter-совместимой среде и выполните все ячейки по порядку.
